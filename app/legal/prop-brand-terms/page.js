...
const sections = [
  {
    heading: 'T&Cs for the Prop Brand website',
    content: [
      'Last updated: August 10, 2026',
      'Operated by FX-EDGE V LTD, a company organized and existing under the laws of Vanuatu, with its registered office at 1276, Govant Building, Kumul Highway, Port Vila, Vanuatu, registered under number 700604 (the “Company”, “we”, “us” or “our”).',
  ...
  {
    heading: '1. Nature of the Services',
    content: [
      ...
      '1.9. Payment Settlement by Odeonpay ALE S.R.L ("Paysagi") The Supplier is FX-EDGE V LTD. Payments are settled via Odeonpay ALE S.R.L. (“Paysagi”), acting solely as Merchant of Record for transaction settlement purposes. Paysagi is not the supplier of the goods or services. Payment settlement is subject to Paysagi’s Terms of Use, available at https://paysagi.com/terms-of-use/, which are presented to customers during the payment process.',
    ],
  },
  {
